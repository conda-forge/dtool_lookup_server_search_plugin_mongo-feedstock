About dtool_lookup_server_search_plugin_mongo-feedstock
=======================================================
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/dtool_lookup_server_search_plugin_mongo-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/dtool_lookup_server_search_plugin_mongo-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add dtool_lookup_server_search_plugin_mongo
# for installing globally
pixi global install dtool_lookup_server_search_plugin_mongo
```
...
It is possible to list all of the versions of `dtool_lookup_server_search_plugin_mongo` available on your platform:
...
```
pixi search dtool_lookup_server_search_plugin_mongo --channel conda-forge
```
